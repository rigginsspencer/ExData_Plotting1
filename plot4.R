...
par(mfrow=c(2,2))
#Top Left
plot(power$date_and_time, power$Global_active_power, type="o", pch=".", ylab="Global Active Power", xlab="")
#Top Right
plot(power$date_and_time, power$Voltage, type="o", pch=".", ylab="Voltage", xlab="datetime")
#Bottom Left
...
legend("topright",legend=c("Sub_Metering_1", "Sub_Metering_2", "Sub_Metering_3"), col=c("black","red","blue"), lty=1, bty="n", fill="white", border=FALSE)
#Bottom Right
plot(power$date_and_time, power$Global_reactive_power, type="o", pch=".", ylab="Global_reactive_power", xlab="datetime")
